...
(function ($) {
  ...
  $.fn.raptorize = function (options) {
    ...
    return this.each(function () {
      ...
      let raptorImageMarkup = '<img id="elRaptor" style="display: none" src="images/raptor.png" />'
      let raptorAudioMarkup = '<audio id="elRaptorShriek" preload="auto"><source src="sounds/raptor-sound.mp3" /><source src="sounds/raptor-sound.ogg" /></audio>';
      let locked = false;
